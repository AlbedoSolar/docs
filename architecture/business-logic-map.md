...
3. **Grace/duration off-by-one**: dbt `int_projects_mega_view` counts the month-0 closing row; contract generator (fixed 2026-07-03) excludes it. dbt still over-reports.
