...
This document describes every dbt model in the `dbt/main/` project. It is intended as a quick-reference wiki for engineers and analysts who need to understand what data is available, where it comes from, and how it is calculated.

**Location**: `dbt/main/`
**Data source**: Static Supabase tables (`public.*`)
